...
class Siswa_model extends CI_Model
{
    ...
    public function buat_tabel($data)
    {
        ...
        if ($this->session->userdata('usename') == "admin") {
            ...
            $this->table->set_heading('No', 'NIS', 'Nama', 'Kelas');
    ...
    public function tambah()
    {
        $siswa = array(
            ...
            'latitude_rumah' => $this->input->post('latitude'),
            'longitude_rumah' => $this->input->post('longitude'),
        );
