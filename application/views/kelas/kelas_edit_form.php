...
<div class="form-group">
    ...
    <input type="text" id="id_kelas" name="id_kelas" class="form-control" value="<?= $kelas->id_kelas ?> ">
</div>
...
<div class="form-group">
    ...
    <input type="text" id="kelas" name="kelas" class="form-control" value="<?= $kelas->kelas ?> ">
</div>
