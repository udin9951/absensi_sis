...
<div class="form-group">
    ...
    <select name="id_kelas" id="id_kelas" class="form-control" required>
        ...
        <?php foreach ($select as $key) { ?>
            <option value="<?= $key->id_kelas ?>" <?php if ($siswa->id_kelas == $key->id_kelas) echo "selected" ?>><?= $key->kelas  ?></option>
        <?php } ?>
    </select>
</div>
<div class="form-group">
    ...
    <select name="wali_kelas" id="wali_kelas" class="form-control" required>
        ...
        <?php foreach ($wali_kelas as $key) { ?>
            <option value="<?= $key->nopeg ?>" <?php if ($siswa->wali_kelas == $key->nopeg) echo "selected" ?>><?= $key->nama  ?></option>
        <?php } ?>
    </select>
</div>
